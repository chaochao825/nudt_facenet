# FACENET Face Recognition - Attack & Defense System

This project implements a comprehensive face recognition attack and defense system using the FACENET model.
...
```bash
# Build Docker image
docker build -t nudt_facenet:latest .
```
...
```bibtex
@software{nudt_facenet_2024,
  title = {FACENET Face Recognition Attack & Defense System},
  author = {NUDT Research Team},
  year = {2024},
  url = {https://github.com/your-repo/nudt_facenet}
}
```
...
- FACENET authors for the face recognition model
